...
public class WantsLongPerformanceRule : Rule
{
    public override void Define()
    {
        ...
        When()
            .Match(() => user, u => u.WantsLongPerformance)
            .Match(() => rec);
    ...
    private static void Apply(Recommendation rec)
    {
        ...
        rec.Reasons.Add("User wants long performance → longevity should be at least medium");
    }
}
